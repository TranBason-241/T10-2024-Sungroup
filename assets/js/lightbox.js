            ...
            Plugin.prototype.loadContent = function (index, rec, delay) {
              ...
              if (!_lgUtils2.default.hasClass(_this.___slide[index], "lg-loaded")) {
                if (iframe) {
                  ...
                  _this.___slide[index].insertAdjacentHTML(
                    "beforeend",
                    '<div class="lg-video-cont ' + videoClass + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + _poster + '" /></div></div>'
                  );
                } else if (_isVideo) {
              ...
              if (!_this.lgBusy) {
                if (this.s.download) {
                  ...
                  if (_this.s.dynamic) {
                    ...
                    _src =
                      _this.items[index].getAttribute("data-download-url") !== "false" &&
                      (_this.items[index].getAttribute("data-download-url") || _this.items[index].getAttribute("href") || _this.items[index].getAttribute("data-src"));
                  }
            ...
            Plugin.prototype.touchEnd = function (distance) {
              ...
              for (var i = 0; i < this.___slide.length; i++) {
                if (
                  ...
                  !_lgUtils2.default.hasClass(this.___slide[i], "lg-prev-slide") &&
